...
public class MainActivity extends AppCompatActivity {
    ...
    private List<Audio> mAudioList = App.getAudios();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mRefreshLayout.setGive(RefreshLayout.Give.TOP);
        mRefreshLayout.setHeader(new DefaultHeader(this));
        checkPerssion();
    }

    private void reLoadList() {
        mAudioList = App.getAudios();
    ...
    private void checkPerssion() {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
            boolean checkpermission1 = checkpermission(Manifest.permission.READ_EXTERNAL_STORAGE);
            boolean checkpermission2 = checkpermission(Manifest.permission.WRITE_EXTERNAL_STORAGE);
            boolean checkpermission3 = checkpermission(Manifest.permission.RECORD_AUDIO);
            boolean checkpermission4 = checkpermission(Manifest.permission.MODIFY_AUDIO_SETTINGS);
